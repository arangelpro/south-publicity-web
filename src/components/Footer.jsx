    ...
    <div className="container">
      <div className="Footer-content">
        <div className="Footer-about">
          <div className="Footer-about-info">
            ...
            <p>
              ...
              dolore voluptate illum nobis nostrum vero impedit at. Illum
              accusantium maiores mollitia quas debitis cumque magnam alias
              nulla quidem amet? Perspiciatis!
            </p>
          </div>
        ...
        <div className="Footer-copyright">
          <p>
            <i className="far fa-copyright" /> 2020 South Publicity Spa.
          </p>
        </div>
      </div>
    </div>
