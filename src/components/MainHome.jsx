    ...
    <div className="container">
      <div className="MainHome-info">
        ...
        <p className="MainHome-info-description">
          Te ayudamos y te guiamos en cualquier etapa de tu proyecto o empresa,
          Seremos tu brújula en los Negocios Online y tradicionales.
        </p>
      </div>
      <div className="MainHome-image">
        <img
          ...
          alt="Ilustracion"
        />
        <img className="MainHome-image_neon" src={Neon} alt="Neon" />
        <img className="MainHome-image_growth" src={Growth} alt="Growth" />
      </div>
    </div>
  </section>
);
